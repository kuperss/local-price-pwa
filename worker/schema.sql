...
CREATE TABLE IF NOT EXISTS cost_bundles (
 version TEXT PRIMARY KEY, key_b64 TEXT NOT NULL, iv_b64 TEXT NOT NULL,
 content_hash TEXT NOT NULL, chunks INTEGER NOT NULL, product_count INTEGER NOT NULL
);
CREATE TABLE IF NOT EXISTS cost_chunks(version TEXT NOT NULL, seq INTEGER NOT NULL, content TEXT NOT NULL, PRIMARY KEY(version,seq));
